...
public class UserMapper {
    ...
    public static RoleEntity mapRoleToRoleEntity(UserEntity userEntity) {
        ...
        role.setUsers(Collections.singleton(userEntity));
        ...
        authority_read.setRoles(Collections.singleton(role));
        ...
        authority_write.setRoles(Collections.singleton(role));
        ...
        authority_delete.setRoles(Collections.singleton(role));

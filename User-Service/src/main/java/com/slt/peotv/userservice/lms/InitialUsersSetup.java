...
public class InitialUsersSetup {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        RoleEntity roleCHAIRMAN = createRole(Roles.ROLE_CHAIRMAN.name(), Arrays.asList(readAuthority,writeAuthority, deleteAuthority));
...
//        adminUser.setRoles(Arrays.asList(roleAdmin, roleCEO,roleEMPLOYEE, roleHOD , roleSUPAVISOR));
        ...
        UserEntity storedUserDetails = userRepository.findByEmail("admin@lms.com");

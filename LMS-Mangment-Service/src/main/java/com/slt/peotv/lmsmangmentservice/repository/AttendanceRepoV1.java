...
@Repository
public interface AttendanceRepoV1 extends CrudRepository<AttendanceEntity, Long> {
    ...
    List<AttendanceEntity> findByEmployeeIDAndDate(String EmployeeID, Date date);

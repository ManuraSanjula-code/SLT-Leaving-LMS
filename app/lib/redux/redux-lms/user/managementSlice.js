        ...
        try {
            ...
            const [roles, authorities, profiles, roleNames, sectionNames, profileNames, sections] =
                await Promise.all([
                    ...
                    fetchWithHeaders(`${baseUrl}/authorities`).then(res => res.json()),
                    fetchWithHeaders(`${baseUrl}/profile`).then(res => res.json()),
                    fetchWithHeaders(`${baseUrl}/names/roles`).then(res => res.json()),
                    fetchWithHeaders(`${baseUrl}/names/sections`).then(res => res.json()),
                    fetchWithHeaders(`${baseUrl}/names/profiles`).then(res => res.json()),
...
export const deleteRole = createAsyncThunk(
    ...
    async (roleId, {rejectWithValue}) => {
        try {
            ...
            const response = await fetchWithHeaders(`${baseUrl}/delete/role/${roleId}/${userId}`, {
                method: 'DELETE',
                credentials: 'include',
                headers: {'Content-Type': 'application/json'},
            });
...
export const deleteSection = createAsyncThunk(
    ...
    async (sectionId, {rejectWithValue}) => {
        try {
            ...
            const response = await fetchWithHeaders(`${baseUrl}/section/${sectionId}/${userId}`, {
                method: 'DELETE',
                credentials: 'include',
                headers: {'Content-Type': 'application/json'},
            });
...
export const deleteProfile = createAsyncThunk(
    ...
    async (profileId, {rejectWithValue}) => {
        try {
            ...
            const response = await fetchWithHeaders(`${baseUrl}/profile/${profileId}/${userId}`, {
                method: 'DELETE',
                credentials: 'include',
                headers: {'Content-Type': 'application/json'},
            });
...
export const deleteEmployee = createAsyncThunk(
    ...
    async (employeeId, {rejectWithValue}) => {
        try {
            ...
            const response = await fetchWithHeaders(`${baseUrl}/${employeeId}/${userId}`, {
                method: 'DELETE',
                credentials: 'include',
                headers: {'Content-Type': 'application/json'},
            });

...
const mockActivities = [
    ...
    { id: 2, employeeName: "Jane Smith", type: "Casual Leave", date: "2023-10-05", status: "Pending" },
    { id: 3, employeeName: "Alice Johnson", type: "Annual Leave", date: "2023-10-10", status: "Approved" },
    { id: 4, employeeName: "Bob Brown", type: "Movement", date: "2023-10-15", status: "Pending" },
    { id: 5, employeeName: "Charlie Davis", type: "Absence", date: "2023-10-20", status: "Not Approved" },
];
...
const EmployeeActivities = () => {
    ...
    // Filter activities based on search term, type, and status

...
const ManageEmployees = ({hr = false}) => {
        ...
        <>
            ...
            <Container maxWidth="xl">
                ...
                <Box sx={{mt: 4}}>
                    ...
                    {(!hr) && (<Tabs value={activeTab} onChange={handleTabChange} sx={{mb: 3}}>
            ...
            >
                ...
                <MenuItem
                    onClick={() => handleMenuItemClick(`/single-employee-activities/${userId}`)}>Attendance</MenuItem>
                <MenuItem onClick={() => handleMenuItemClick(`/in-outs/${userId}`)}>In-Outs</MenuItem>
                {(!hr) && (<MenuItem onClick={() => handleMenuItemClick(`/employee-edit/${userId}`)}>
                    Edit Profile
                </MenuItem>)}
